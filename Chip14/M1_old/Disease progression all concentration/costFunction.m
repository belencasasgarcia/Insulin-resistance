...
Optparam_11mM(parIndex.i_G0_7)=10.860;
Optparam_11mM(parIndex.i_I0_7)=9.8539;
...
try
    simData_islets_liver = feval(char(modelName), SIMTIME, icOrig0, Optparam_11mM, COSTOPTIONS);
...
Optparam_5p5mM(parIndex.i_G0_7)=5.185;
Optparam_5p5mM(parIndex.i_I0_7)=9.376;
