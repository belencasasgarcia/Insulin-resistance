...
OPTIONS.lowbounds(6)=400;                 % km
OPTIONS.lowbounds(7)=1e-9;                % kv
OPTIONS.lowbounds(8)=1;                   % Km_f_islets
OPTIONS.lowbounds(9)=8;                   % G0_7
OPTIONS.lowbounds(10)=0;                  % I0_7
...
OPTIONS.highbounds(9)=12;                 % G0_7
OPTIONS.highbounds(10)=20;                % I0_7
...
startGuess(9)=11;                         % G0_7
startGuess(10)=0;                         % I0_7
