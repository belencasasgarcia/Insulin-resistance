function plotFunctionUncertainty_lines(param, model, parIndex, param_opt, simTime_11mM, simTime_5p5mM)
...
for j = 1 : size(param,1)
    plot(simTime_11mM,plotData.S_cap_11mM(j,1:nTime_11mM),'Color',color11mM)
    hold on
end
