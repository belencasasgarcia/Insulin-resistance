...
param(:,parIndex.i_G0_7)=5.185;

param_opt(:,parIndex.i_G0)=5.5;
param_opt(:,parIndex.i_G0_7)=5.185;
...
for j = 1 : size(param,1) % For each row of the param set.
    ...
    plotData.Guptake_ratio_5p5mM(j,1:nTime_11mM)=plotData.Guptake_id_5p5mM(j,1:nTime_11mM)./plotData.Guptake_ii_11mM(j,1:nTime_11mM)*100;
