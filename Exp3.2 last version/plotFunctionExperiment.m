...
color11mM =  [204, 0, 51]/255;    % Red
color5p5mM = [235, 174, 9]/255;    % Green
...
% You have changed the insulin sensitivity to match the first part of the
% low HC experiment

k_ins_nM=1/144;


param(:,parIndex.i_S_i)=param(:,parIndex.i_S_i)/2.5;
...
iC_5p5mM=[(5.5+param(j,parIndex.i_delta_G_1_5p5mM))*param(j,parIndex.i_V_m_hep) ...
            (5.5+param(j,parIndex.i_delta_G_1_5p5mM))*param(j,parIndex.i_V_m_islets)...
            (0+param(j,parIndex.i_delta_I_1_5p5mM))*param(j,parIndex.i_V_m_hep) ...
            (0+param(j,parIndex.i_delta_I_1_5p5mM))*param(j,parIndex.i_V_m_islets) 0 0 ...
            5.5 0.0000000088 0 0];
...
area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.Gmeasured_11mM_max,fliplr(plotData.Gmeasured_11mM_min)];
f=fill(area1,area2,colorhyper_lowHC,'LineStyle','none');
alpha(f,.2)

hold on
errorbar(EXPDATA.time{7}, EXPDATA.mean{7}, EXPDATA.SD{7},'Color', colorhyper_lowHC,...
    'LineStyle', 'n', 'Marker',marker,'MarkerFaceColor',colorhyper_lowHC, 'MarkerSize',8)

% hold on
% plot(simTime_5p5mM,plotData.Gmeasured_11mM_opt,'Color', colornormo_lowHC,'Linewidth',2);
...
area1=[simTime_5p5mM,fliplr(simTime_5p5mM)];
area2=[plotData.Gmeasured_5p5mM_max,fliplr(plotData.Gmeasured_5p5mM_min)];
f=fill(area1,area2,colornormo_lowHC,'LineStyle','none');
alpha(f,.2)
...
hold on
errorbar(EXPDATA.time{9}, EXPDATA.mean{9}, EXPDATA.SD{9},'Color', colornormo_lowHC,...
    'LineStyle', 'n', 'Marker',marker,'MarkerFaceColor',colornormo_lowHC, 'MarkerSize',8)
% hold on
% plot(simTime_5p5mM,plotData.Gmeasured_5p5mM_opt,'Color', colornormo_lowHC,'Linewidth',2);
...
area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.Imeasured_11mM_max/144,fliplr(plotData.Imeasured_11mM_min/144)];
f=fill(area1,area2,colorhyper_lowHC,'LineStyle','none');
alpha(f,.2)
...
hold on
errorbar(EXPDATA.time{8}, EXPDATA.mean{8}/144, EXPDATA.SD{8}/144,'Color', colorhyper_lowHC,...
    'LineStyle', 'n', 'Marker',marker,'MarkerFaceColor',colorhyper_lowHC, 'MarkerSize',8)
% hold on
% plot(simTime_5p5mM,plotData.Imeasured_11mM_opt,'Color', colorhyper_lowHC,'Linewidth',2);
...
area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.Imeasured_5p5mM_max/144,fliplr(plotData.Imeasured_5p5mM_min/144)];
f=fill(area1,area2,colornormo_lowHC,'LineStyle','none');
alpha(f,.2)

hold on
errorbar(EXPDATA.time{10}, EXPDATA.mean{10}/144, EXPDATA.SD{10}/144,'Color', colornormo_lowHC,...
    'LineStyle', 'n', 'Marker',marker,'MarkerFaceColor',colornormo_lowHC, 'MarkerSize',8)
% hold on
% plot(simTime_5p5mM,plotData.Imeasured_5p5mM_opt,'Color', colornormo_lowHC,'Linewidth',2);
