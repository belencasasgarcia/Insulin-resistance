...
% responses from the model corresponding to Hypothesis 2, considering high
% hydrocortisone (HC), and the corresponding experimental data
...
loadExperimentalDataExp1_corrected

modelName ='H2_experiment';

optModel = IQMmodel(strcat(modelName,'.txt')); 
% To create MEX model, remove comment from the following line
...
% Find experimental values corresponding to the simulation times
...
% insulin data from normo and hyperglycemia
...
OPTIONS.lowbounds(8)=48;                  % Km_f_add
OPTIONS.lowbounds(9)=1;                   % Km_f_islets
OPTIONS.lowbounds(10)=-2;                 % delta_G_1_11mM
OPTIONS.lowbounds(11)=-2;                 % delta_G_13_11mM
OPTIONS.lowbounds(12)=0;                  % delta_I_1_11mM
OPTIONS.lowbounds(13)=0;                  % delta_I_13_11mM
OPTIONS.lowbounds(14)=-2;                 % delta_G_13_5p5mM
OPTIONS.lowbounds(15)=0;                  % delta_I_13_5p5mM
...
OPTIONS.highbounds(1)=1000;               % U_ii_hep
OPTIONS.highbounds(2)=1;                  % S_i
...
OPTIONS.highbounds(8)=3000;               % Km_f_add
OPTIONS.highbounds(9)=3000;               % Km_f_islets
OPTIONS.highbounds(10)=2;                 % delta_G_1_11mM
OPTIONS.highbounds(11)=2;                 % delta_G_13_11mM
OPTIONS.highbounds(12)=150;               % delta_I_1_11mM
OPTIONS.highbounds(13)=150;               % delta_I_13_11mM
OPTIONS.highbounds(14)=2;                 % delta_G_13_5p5mM
OPTIONS.highbounds(15)=150;               % delta_I_13_5p5mM
...
startGuess(11)=0;                         % delta_G_13_11mM
startGuess(12)=0;                         % delta_I_1_11mM
startGuess(13)=0;                         % delta_I_13_11mM
startGuess(14)=0;                         % delta_G_13_5p5mM
startGuess(15)=0;                         % delta_I_13_5p5mM
...
OPTIONS.index_Optpar=logical(sum([parIndex.i_U_ii_hep...
    ...
    parIndex.i_delta_G_1_11mM parIndex.i_delta_G_13_11mM...
    parIndex.i_delta_I_1_11mM parIndex.i_delta_I_13_11mM...
    parIndex.i_delta_G_13_5p5mM parIndex.i_delta_I_13_5p5mM],2)); %Indexes of the parameters to optimize
