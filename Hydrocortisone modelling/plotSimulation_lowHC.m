function [] = plotSimulation_lowHC(SSsimData,plotFluxes)
...
errorbar(EXPDATA.time{7},EXPDATA.mean{7},EXPDATA.SD{7},'r.',...
    'linewidth',1)
...
errorbar(EXPDATA.time{8},EXPDATA.mean{8},EXPDATA.SD{8},'r.',...
    'linewidth',1)
