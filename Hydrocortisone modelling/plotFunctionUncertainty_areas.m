function plotFunctionUncertainty_areas(param, model, parIndex, param_opt, simTime_11mM, simTime_5p5mM)
...
% Remove values where insulin independent glucose uptake < 48% glucose
% uptake (based on Bauer et al. Sci.Rep 2017)

param=[param(1:12,:);param(14:end,:)];
...
for j = 1 : size(param,1) % For each row of the param set.
    ...
    plotData.Guptake_ii_11mM(j,1:nTime_11mM) = simData_11mM{1}.variablevalues(:,29);
    plotData.Guptake_id_11mM(j,1:nTime_11mM) = simData_11mM{1}.variablevalues(:,30);
    plotData.Guptake_ratio_11mM(j,1:nTime_11mM)=plotData.Guptake_id_11mM(j,1:nTime_11mM)./plotData.Guptake_ii_11mM(j,1:nTime_11mM)*100;
    plotData.F_hep_11mM(j,1:nTime_11mM) = simData_11mM{1}.variablevalues(:,31);
    plotData.F_G_11mM(j,1:nTime_11mM) = simData_11mM{1}.variablevalues(:,32);
...
plotData.Guptake_ii_11mM_min(j,1:nTime_11mM) = min(plotData.Guptake_ii_11mM,[],1);
plotData.Guptake_ii_11mM_max(j,1:nTime_11mM) = max(plotData.Guptake_ii_11mM,[],1);
plotData.Guptake_id_11mM_min(j,1:nTime_11mM) = min(plotData.Guptake_id_11mM,[],1);
plotData.Guptake_id_11mM_max(j,1:nTime_11mM) = max(plotData.Guptake_id_11mM,[],1);
plotData.Guptake_ratio_11mM_min(j,1:nTime_11mM)=min(plotData.Guptake_ratio_11mM,[],1);
plotData.Guptake_ratio_11mM_max(j,1:nTime_11mM)=max(plotData.Guptake_ratio_11mM,[],1);
plotData.F_hep_11mM_min(j,1:nTime_11mM)=min(plotData.F_hep_11mM,[],1);
plotData.F_hep_11mM_max(j,1:nTime_11mM)=max(plotData.F_hep_11mM,[],1);
plotData.F_G_11mM_min(j,1:nTime_11mM)=min(plotData.F_G_11mM,[],1);
plotData.F_G_11mM_max(j,1:nTime_11mM)=max(plotData.F_G_11mM,[],1);
...
area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.Guptake_ii_11mM_max,fliplr(plotData.Guptake_ii_11mM_min)];
f=fill(area1,area2,color11mM,'LineStyle','none');
alpha(f,.2)
...
area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.Guptake_id_11mM_max,fliplr(plotData.Guptake_id_11mM_min)];
f=fill(area1,area2,color11mM,'LineStyle','none');
alpha(f,.2)
...
for j = 1 : size(param,1)
    plot(simTime_11mM,plotData.Guptake_ratio_11mM(j,1:nTime_11mM),'Color',color11mM,'Linewidth',1.5)
    hold on
end
area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.Guptake_ratio_11mM_max,fliplr(plotData.Guptake_ratio_11mM_min)];
f=fill(area1,area2,color11mM,'LineStyle','none');
alpha(f,.2)
...
%title('Measured')
xlabel('Time (h)','FontSize',20);
ylabel('Glucose uptake ratio ii/id (%)','FontSize',20)
set(gca,'TickDir','out','FontSize',20);
box off
...
% Decay in insulin sensitivity fue to composition of the co-culture medium
subplot (2,3,5)
hold on

area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.F_hep_11mM_max,fliplr(plotData.F_hep_11mM_min)];
f=fill(area1,area2,color11mM,'LineStyle','none');
alpha(f,.2)
...
hold on
for j = 1 : size(param,1)
    plot(simTime_11mM,plotData.F_hep_11mM(j,1:nTime_11mM),'Color',color11mM)
    hold on
end
...
%title('Measured')
xlabel('Time (h)','FontSize',20);
ylabel('Decay in insulin sensitivity due to co-culture medium','FontSize',20)
set(gca,'TickDir','out','FontSize',20);
box off


% Decay in insulin sensitivity due to glucose  levels
subplot (2,3,6)
hold on

area1=[simTime_11mM,fliplr(simTime_11mM)];
area2=[plotData.F_G_11mM_max,fliplr(plotData.F_G_11mM_min)];
f=fill(area1,area2,color11mM,'LineStyle','none');
alpha(f,.2)
...
hold on
for j = 1 : size(param,1)
    plot(simTime_11mM,plotData.F_G_11mM(j,1:nTime_11mM),'Color',color11mM)
    hold on
end
...
%title('Measured')
xlabel('Time (h)','FontSize',20);
ylabel('Decay in insulin sensitivity due glucose levels','FontSize',20)
set(gca,'TickDir','out','FontSize',20);
box off
...
for j = 1 : size(param,1) % For each row of the param set.
    ...
    plotData.Guptake_ii_5p5mM(j,1:nTime_11mM) = simData_5p5mM{1}.variablevalues(:,29);
    plotData.Guptake_id_5p5mM(j,1:nTime_11mM) = simData_5p5mM{1}.variablevalues(:,30);
