function [error] = costFunction_lowHC(parameters)
...
% Optparam_11mM(parIndex.i_delta_G_1)=-1.481;
% Optparam_11mM(parIndex.i_delta_G_7)=-0.14;
% Optparam_11mM(parIndex.i_delta_I_1)=131.1;
% Optparam_11mM(parIndex.i_delta_I_7)=9.539;
...
% 1: Measured glucose with liver+islets and (variable 1)
...
if n==7 || n==8
    ...
    simData_values=simData_islets_liver.variablevalues(:,n-6);
    index_int=ismembertol(SIMTIME,EXPDATA.time{n-6});
